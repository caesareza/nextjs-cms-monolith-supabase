...
export default async function PublicSharedArticleView({
  params,
}: PublicViewProps) {
        ...
        <div className="max-w-[440px] w-full text-center bg-white p-10 rounded-2xl border border-slate-200 shadow-sm space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-black text-slate-900 tracking-tight">
              Shared Preview Paused
            </h2>
            <p className="text-xs text-slate-500 leading-relaxed font-semibold">
              The owner of this strategy brief has disabled public external
              reviews or regenerated the access token.
            </p>
          </div>
  ...
  const formattedDate = new Date(article.production_month).toLocaleDateString(
    "id-ID",
    {
      day: "numeric",
      month: "short",
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 antialiased select-text selection:bg-red-50">
        ...
        <div className="w-full bg-slate-50 border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-6 h-9 flex items-center justify-between text-[11px] font-bold text-slate-500">
            <div className="flex gap-2 bg-slate-200 p-0.5 rounded">
              <span className="bg-white px-1.5 py-0.5 rounded text-slate-900 font-black">
                ID
              </span>
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-12">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-xs font-black uppercase tracking-wider text-slate-600">
              ...
              <span>Syariah</span>
              <span>Digital</span>
              <span className="text-[#EE1C25] border-b-2 border-[#EE1C25] pt-7 pb-7">
                Artikel
              </span>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              type="button"
              className="bg-[#EE1C25] text-white px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-wider shadow-md"
            >
              Jadi Nasabah
            </button>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-8 pb-12">
        <button
          type="button"
          className="mb-6 flex items-center gap-1.5 px-4 py-1.5 border border-slate-200 rounded-full text-[10px] font-bold text-slate-500 bg-white"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="pt-4 space-y-2 select-none">
              ...
              <div className="flex items-center gap-2">
                <span className="w-8 h-8 rounded-full bg-blue-800 text-white flex items-center justify-center font-bold text-xs">
                  f
                </span>
                <span className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center font-bold text-xs">
                  𝕏
                </span>
                <span className="w-8 h-8 rounded-full bg-green-500 text-white flex items-center justify-center font-bold text-xs">
                  wa
                </span>
          ...
          <div className="lg:col-span-7">
            <div className="w-full h-64 md:h-96 rounded-2xl overflow-hidden bg-gradient-to-br from-amber-100 via-red-50 to-red-100 relative shadow-inner border border-slate-100">
              <div
                className="absolute right-12 bottom-0 top-0 w-1/2 bg-contain bg-center bg-no-repeat opacity-90"
                style={{
                  backgroundImage: `url('https://images.unsplash.com/photo-1598550476439-6847785fce6e?w=600&auto=format&fit=crop&q=60')`,
                }}
              />
        ...
        <div className="mt-16 pt-8 border-t border-slate-100 space-y-8">
          ...
          <div className="py-10 border-b border-slate-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <button
                type="button"
                className="px-6 py-3 border border-slate-200 hover:border-slate-300 text-xs font-black uppercase text-slate-700 bg-white rounded-xl tracking-wider text-center"
              >
          ...
          <div className="w-full bg-[#E6F7FC] border border-[#D0F0FA] rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 select-none">
            ...
            <div className="flex items-center gap-2">
              <span className="w-9 h-9 rounded-full bg-[#3B5998] text-white flex items-center justify-center font-black text-sm shadow-sm cursor-pointer">
                f
              </span>
              <span className="w-9 h-9 rounded-full bg-black text-white flex items-center justify-center font-black text-sm shadow-sm cursor-pointer">
                𝕏
              </span>
              <span className="w-9 h-9 rounded-full bg-[#25D366] text-white flex items-center justify-center font-black text-sm shadow-sm cursor-pointer">
                wa
              </span>
              <span className="w-9 h-9 rounded-full bg-white text-slate-400 flex items-center justify-center font-black text-sm shadow-sm cursor-pointer border border-slate-200">
                🔗
              </span>
            </div>
          </div>
