            ...
            {loading ? (
                ...
                <div className="divide-y divide-slate-100">
                    {filteredArticles.map((article) => (
                        ...
                        >
                            <div className="flex-1">
                                <h4 className="text-sm font-bold text-slate-800 group-hover:text-[#EE1C25] transition-colors leading-relaxed">
                                    {article.title}
                                </h4>
                            </div>
                  ...
                  {formatAuditTimestamp(article.created_at)}
                            ...
                            <div className="w-10 h-10 rounded-2xl bg-slate-50 flex items-center justify-center group-hover:bg-[#EE1C25] transition-all">
                    ...
                    {filteredArticles.length === 0 && (
                        <div className="p-24 text-center space-y-4">
                            ...
                            <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">
                                {searchTerm ? 'No matching results' : 'Queue is empty'}
                            </p>
                        </div>
                    )}
                </div>
