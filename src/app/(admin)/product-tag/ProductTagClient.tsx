        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-0.5">
              Configure Enterprise Solutions & Core Sub Products
            </p>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-slate-100">
                    ...
                    >
                      ...
                      <td className="px-6 py-4.5">
                        {editingId === tag.id ? (
                          ...
                          <span
                            className={`text-xs font-bold tracking-tight ${isArchived ? "text-slate-400 line-through" : "text-slate-800"}`}
                          >
                            {tag.name}
                          </span>
                        )}
                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          {editingId === tag.id ? (
                            <>
                              <button
                                type="button"
                                onClick={() => handleSaveUpdate(tag.id)}
                            ...
                            <>
                              ...
                              <button
                                type="button"
                                onClick={() =>
                                  handleToggleDelete(tag.id, isArchived)
                                }
                                ...
                                title={
                                  isArchived ? "Restore Tag" : "Soft Delete"
                                }
                              >
                                {isArchived ? (
                                  <RotateCcw size={13} />
                ...
                {productTags.length === 0 && (
                  <tr>
                    ...
                    >
                      No configuration profiles found matching current
                      selections.
                    </td>
                  </tr>
                )}
