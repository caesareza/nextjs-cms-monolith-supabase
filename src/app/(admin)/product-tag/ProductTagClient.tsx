        ...
        <div className="space-y-8"> {/* Enforced Client Layout Rule */}
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl font-extrabold text-slate-900 tracking-tight leading-tight">Product Tag Management</h1>
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-0.5">Configure Enterprise Solutions & Core Sub Products</p>
                    </div>
                </div>
