                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-8">
                    ...
                    <div className="bg-white p-6 border border-slate-200/70 rounded-3xl space-y-4 shadow-xs">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                            ...
                            <span className="text-[9px] font-bold text-slate-400 uppercase">Section 1 of 3</span>
                        </div>
                    ...
                    <div className="bg-white p-6 border border-slate-200/70 rounded-3xl space-y-4 shadow-xs">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                            ...
                            <span className="text-[9px] font-bold text-slate-400 uppercase">Section 2 of 3</span>
                        </div>
                    ...
                    <div className="bg-white p-6 border border-slate-200/70 rounded-3xl space-y-5 shadow-xs">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
                            ...
                            <span className="text-[9px] font-bold text-slate-400 uppercase">Section 3 of 3</span>
                        </div>
