...
export default function DeleteModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl p-10 max-w-md w-full shadow-2xl space-y-6">
        {success ? (
          <div className="text-center space-y-4 animate-in zoom-in-95">
            ...
            <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">
              The article has been moved to trash.
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="text-center space-y-2">
              <h3 className="text-xl font-black text-slate-900 uppercase tracking-tight text-brand-navy">
                Archive Article?
              </h3>
              <p className="text-slate-500 text-xs font-bold leading-relaxed">
                Confirming will hide{" "}
                <span className="text-slate-900">"{articleTitle}"</span> from
                the active list.
              </p>
            </div>
